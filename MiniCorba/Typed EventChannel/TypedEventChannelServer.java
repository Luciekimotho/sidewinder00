...
public class TypedEventChannelServer 
{
	...
	//Creo il servant
	TypedEventChannelImpl typedEventChannel = new TypedEventChannelImpl(orb);
	try
	{
	    ...
	    org.omg.CORBA.Object ref = rootPOA.servant_to_reference(typedEventChannel);
	...
	{ 
	    System.out.println("TypedEventChannelServer:\tATTENZIONE: Impossibile avviare il server e registrarlo!\nMotivo: "+e.getCause());
